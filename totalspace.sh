...
function usage(){
    echo
    echo "usage: totalspace.sh [-a] [-d date_value] [-l int_value or -L int_value] [-n regular_expression] [-r] dir1 [dir2 ...]"
